...
public class NewPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cameratool = findViewById(R.id.camera_toolbar);
        mPostTextField = findViewById(R.id.postText);
        imagePreview = findViewById(R.id.image);
        imageUser = findViewById(R.id.photouser);
        ...
        GlideApp.with(NewPostActivity.this).load(photouser).circleCrop().into(imageUser);

        cameratool.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void submitPost() throws ParseException {
    ...
    public void writeNewPost(String postText, String mediaUrl) {
